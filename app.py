...
# ============== DARAJA CONFIG (from Render environment variables) ==============
...
def init_db():
    ...
    # New table to store created/analyzed emails (kept for 7 days)
    c.execute('''
...
if __name__ == "__main__":
    app.run(debug=True)Enter                         payment_in_progress=payment_in_progress)
